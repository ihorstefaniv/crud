...
function groupAction(userIds, action) {
  $.ajax({
    url: "/user-group-action",
    type: "post",
    data: {
      id: userIds,
      action: action,
...
function addToTable(user) {
  let out =
    ...
    '            <input type="checkbox" class="custom-control-input check-item" data-user="' +
    user.id +
    '" id="item-' +
    user.id +
    '">\n' +
  ...
  out +=
    ...
    '            <button class="btn btn-sm btn-outline-secondary badge user-edit" data-user="' +
    user.id +
    '" type="button">Edit</button>\n' +
    '            <button class="btn btn-sm btn-outline-secondary badge user-delete" data-user="' +
    user.id +
